        ...
        return (
            <React.Fragment>
                ...
                <form className="form-inline">
                    <input className="form-control mr-sm-2" type="search" placeholder="Transaksi ID" aria-label="Search" value={ this.state.query } onChange={ evt => this.updateQuery(evt) } onKeyPress={this.onSearchPress.bind(this)} />
                    <input className="form-control mr-sm-2" type="search" placeholder="Limit" aria-label="Search" value={ this.state.limit } onChange={ evt => this.updateLimit(evt) } onKeyPress={this.onSearchPress.bind(this)} />
                </form>
